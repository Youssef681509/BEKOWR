 ...
 */
final class Version20250209190141 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE donation DROP date_of_donation, CHANGE date_of_receipt date_of_receipt DATETIME NOT NULL');
        $this->addSql('ALTER TABLE donor CHANGE bank_id bank_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE donation ADD date_of_donation DATE DEFAULT NULL, CHANGE date_of_receipt date_of_receipt DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE donor DROP FOREIGN KEY FK_D7F2409711C8FB41');
        $this->addSql('ALTER TABLE donor DROP FOREIGN KEY FK_D7F2409711C8FB41');
        $this->addSql('ALTER TABLE donor CHANGE bank_id bank_id INT DEFAULT NULL');
