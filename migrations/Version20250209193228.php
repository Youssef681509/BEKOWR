 ...
 */
final class Version20250209193228 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE obrsv obs LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE donor ADD CONSTRAINT FK_D7F2409711C8FB41 FOREIGN KEY (bank_id) REFERENCES bank (id)');
        $this->addSql('ALTER TABLE `user` CHANGE obs obrsv LONGTEXT DEFAULT NULL');
    }
}
